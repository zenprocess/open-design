...
export interface Dict {
  ...
  'fileViewer.cloudflareWorkersProvider': string;
  'fileViewer.cloudflareWorkersScriptName': string;
  'fileViewer.cloudflareWorkersCompatibilityDate': string;
  'fileViewer.cloudflareWorkersBindings': string;
  'fileViewer.cloudflareWorkersAddBinding': string;
  'fileViewer.cloudflareWorkersRemoveBinding': string;
  'fileViewer.cloudflareWorkersBindingName': string;
  'fileViewer.cloudflareWorkersBindingBucketName': string;
  'fileViewer.cloudflareWorkersBindingDatabaseId': string;
  'fileViewer.cloudflareWorkersBindingDatabaseName': string;
  'fileViewer.cloudflareWorkersBindingDatabaseNameHint': string;
  'fileViewer.cloudflareWorkersBindingR2CreateHint': string;
  'fileViewer.cloudflareWorkersCustomDomain': string;
  'fileViewer.cloudflareWorkersCustomDomainZone': string;
  'fileViewer.cloudflareWorkersCustomDomainHostname': string;
  'fileViewer.cloudflareWorkersScopeD1Write': string;
  'fileViewer.cloudflareWorkersScopeR2Write': string;
  'fileViewer.cloudflareWorkersBindingsEmpty': string;
  'fileViewer.cloudflareWorkersCapabilities': string;
  'fileViewer.cloudflareWorkersCapabilitiesLoading': string;
  'fileViewer.cloudflareWorkersCapabilitiesLoadFailed': string;
  'fileViewer.cloudflareWorkersCapabilitiesRefresh': string;
  'fileViewer.cloudflareWorkersCapabilitiesEmpty': string;
  'fileViewer.cloudflareWorkersEnabled': string;
  'fileViewer.cloudflareWorkersDisabled': string;
  'fileViewer.cloudflareWorkersWorkers': string;
  'fileViewer.cloudflareWorkersSubdomain': string;
  'fileViewer.cloudflareWorkersR2': string;
  'fileViewer.cloudflareWorkersD1': string;
  'fileViewer.cloudflareWorkersAccess': string;
  'fileViewer.cloudflareWorkersAccessEnabled': string;
  'fileViewer.cloudflareWorkersAccessNotAvailable': string;
  'fileViewer.cloudflareWorkersAccessRule': string;
  'fileViewer.cloudflareWorkersAccessRuleEmails': string;
  'fileViewer.cloudflareWorkersAccessRuleEmailDomain': string;
  'fileViewer.cloudflareWorkersAccessRuleSelf': string;
  'fileViewer.cloudflareWorkersAccessRulePolicy': string;
  'fileViewer.cloudflareWorkersAccessEmailsPlaceholder': string;
  ...
  'fileViewer.cloudflareWorkersReasonUnknown': string;
  'fileViewer.cloudflareWorkersOauthCredentialMode': string;
  'fileViewer.cloudflareWorkersOauthCredentialModeToken': string;
  'fileViewer.cloudflareWorkersOauthCredentialModeOauth': string;
  'fileViewer.cloudflareWorkersOauthClientId': string;
  'fileViewer.cloudflareWorkersOauthRedirectUri': string;
  'fileViewer.cloudflareWorkersOauthScopes': string;
  'fileViewer.cloudflareWorkersOauthScopeZoneRead': string;
  'fileViewer.cloudflareWorkersOauthScopeAccessWrite': string;
  'fileViewer.cloudflareWorkersOauthScopeD1Read': string;
  'fileViewer.cloudflareWorkersOauthScopeR2Read': string;
  'fileViewer.cloudflareWorkersOauthConnect': string;
  'fileViewer.cloudflareWorkersOauthOpening': string;
  'fileViewer.cloudflareWorkersOauthConnected': string;
  'fileViewer.cloudflareWorkersOauthConnectFailed': string;
  'fileViewer.cloudflareWorkersOpenSite': string;
  'fileViewer.cloudflareOAuthSignIn': string;
  'fileViewer.cloudflareOAuthOpening': string;
  'fileViewer.cloudflareOAuthAwaiting': string;
  'fileViewer.cloudflareOAuthNotConnected': string;
  'fileViewer.cloudflareOAuthBound': string;
  'fileViewer.cloudflareOAuthExpiresIn': string;
  'fileViewer.cloudflareOAuthGrantedScopes': string;
  'fileViewer.cloudflareOAuthExpired': string;
  'fileViewer.cloudflareOAuthReconnect': string;
  'fileViewer.cloudflareOAuthDisconnect': string;
  'fileViewer.cloudflareOAuthDisconnecting': string;
  'fileViewer.cloudflareOAuthRefresh': string;
  'fileViewer.cloudflareOAuthOpenManually': string;
