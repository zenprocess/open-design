...
export const zhCN: Dict = {
  ...
  "fileViewer.cloudflareWorkersScriptName": "脚本名称",
  "fileViewer.cloudflareWorkersCompatibilityDate": "兼容性日期",
  "fileViewer.cloudflareWorkersBindings": "绑定",
  "fileViewer.cloudflareWorkersAddBinding": "添加绑定",
  "fileViewer.cloudflareWorkersRemoveBinding": "移除",
  "fileViewer.cloudflareWorkersBindingName": "绑定名称",
  "fileViewer.cloudflareWorkersBindingBucketName": "存储桶名称",
  "fileViewer.cloudflareWorkersBindingDatabaseId": "数据库 ID",
  'fileViewer.cloudflareWorkersBindingDatabaseName': '数据库名称（不存在时创建）',
  'fileViewer.cloudflareWorkersBindingDatabaseNameHint': '将 ID 留空即可在部署时按此名称创建 D1 数据库',
  'fileViewer.cloudflareWorkersBindingR2CreateHint': '存储桶不存在时会自动创建',
  'fileViewer.cloudflareWorkersCustomDomain': '自定义域名',
  'fileViewer.cloudflareWorkersCustomDomainZone': '区域',
  'fileViewer.cloudflareWorkersCustomDomainHostname': '主机名',
  'fileViewer.cloudflareWorkersScopeD1Write': 'D1 写入',
  'fileViewer.cloudflareWorkersScopeR2Write': 'R2 存储写入',
  "fileViewer.cloudflareWorkersBindingsEmpty": "暂无绑定。",
  "fileViewer.cloudflareWorkersCapabilities": "功能",
  "fileViewer.cloudflareWorkersCapabilitiesLoading": "加载中…",
  "fileViewer.cloudflareWorkersCapabilitiesLoadFailed": "无法加载功能。",
  "fileViewer.cloudflareWorkersCapabilitiesRefresh": "刷新",
  "fileViewer.cloudflareWorkersCapabilitiesEmpty": "保存设置后可查看功能。",
  "fileViewer.cloudflareWorkersEnabled": "已启用",
  "fileViewer.cloudflareWorkersDisabled": "已禁用",
  "fileViewer.cloudflareWorkersWorkers": "Workers",
  "fileViewer.cloudflareWorkersSubdomain": "Workers Dev 子域名",
  "fileViewer.cloudflareWorkersR2": "R2",
  "fileViewer.cloudflareWorkersD1": "D1",
  "fileViewer.cloudflareWorkersAccess": "Access",
  "fileViewer.cloudflareWorkersAccessEnabled": "私有 (Cloudflare Access)",
  "fileViewer.cloudflareWorkersAccessNotAvailable": "此凭据无法使用 Cloudflare Access",
  "fileViewer.cloudflareWorkersAccessRule": "谁可以打开此部署",
  "fileViewer.cloudflareWorkersAccessRuleEmails": "特定电子邮件",
  "fileViewer.cloudflareWorkersAccessRuleEmailDomain": "邮箱域名",
  "fileViewer.cloudflareWorkersAccessRuleSelf": "仅我自己",
  "fileViewer.cloudflareWorkersAccessRulePolicy": "现有 Access 策略",
  ...
  'fileViewer.cloudflareWorkersOauthCredentialMode': '凭据方式',
  'fileViewer.cloudflareWorkersOauthCredentialModeToken': 'API 令牌',
  'fileViewer.cloudflareWorkersOauthCredentialModeOauth': '使用 Cloudflare 登录',
  'fileViewer.cloudflareWorkersOauthClientId': '客户端 ID',
  'fileViewer.cloudflareWorkersOauthRedirectUri': '重定向 URI',
  'fileViewer.cloudflareWorkersOauthScopes': '作用域',
  'fileViewer.cloudflareWorkersOauthScopeZoneRead': '读取区域',
  'fileViewer.cloudflareWorkersOauthScopeAccessWrite': '写入 Access 应用',
  'fileViewer.cloudflareWorkersOauthScopeD1Read': '读取 D1',
  'fileViewer.cloudflareWorkersOauthScopeR2Read': '读取 R2 存储',
  'fileViewer.cloudflareWorkersOauthConnect': '连接 Cloudflare',
  'fileViewer.cloudflareWorkersOauthOpening': '正在打开 Cloudflare…',
  'fileViewer.cloudflareWorkersOauthConnected': '已连接',
  'fileViewer.cloudflareWorkersOauthConnectFailed': '无法启动 Cloudflare 登录。',
  'fileViewer.cloudflareWorkersOpenSite': '打开已部署的站点',
  'fileViewer.cloudflareOAuthSignIn': '使用 Cloudflare 登录',
  'fileViewer.cloudflareOAuthOpening': '正在打开浏览器…',
  'fileViewer.cloudflareOAuthAwaiting': '正在等待 Cloudflare 授权…',
  'fileViewer.cloudflareOAuthNotConnected': '未连接',
  'fileViewer.cloudflareOAuthBound': '已绑定到账户 {accountId}',
  'fileViewer.cloudflareOAuthExpiresIn': '令牌将在 {minutes} 分钟后过期',
  'fileViewer.cloudflareOAuthGrantedScopes': '已授予的作用域：{scope}',
  'fileViewer.cloudflareOAuthExpired': '令牌已过期。请重新登录。',
  'fileViewer.cloudflareOAuthReconnect': '重新连接',
  'fileViewer.cloudflareOAuthDisconnect': '断开连接',
  'fileViewer.cloudflareOAuthDisconnecting': '正在断开连接…',
  'fileViewer.cloudflareOAuthRefresh': '刷新状态',
  'fileViewer.cloudflareOAuthOpenManually': '手动打开授权页面',
